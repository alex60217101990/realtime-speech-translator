...
//
// Build tag `mt` gates this package because SentencePiece must be
// compiled from third_party/sentencepiece first
// (scripts/build-deps.sh sentencepiece). Without -tags mt the
